const id = "project-2/index.md";
						...
						const data = {title:"Chantier de Lyon",description:"Chantier d'une belle villa vue montagne de Lyon",date:new Date(1711400400000)};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Mahmut/Desktop/Astro Projeler/astro-nano-mason/src/content/projects/project-2/index.md",
							rawData: undefined,
						};
